...
✔ 이에 재소자들을 대상으로 하는 인문학 또는 심리상담, 직업훈련소 등을 제안할 수 있다.
```
![요일](https://user-images.githubusercontent.com/122436389/219292613-5892e08b-fbad-4b6c-83bd-4a4a68530d6d.png)
```
🌞자료 활용 방안
1. 보안업체에서 CCTV 등 보안 상품을 판매하기 위한 참고 자료로 사용 가능
2. 시,도,군으로 세부 조사 할 경우, 지자체의 순찰 강화, 범죄 예방 캠패인 등 요청시 활용
